...
class MultiLevelEmbedding(nn.Module):
    def __init__(self,
        ...
        # Learned embeddings
        self.max_len = max_len # added fix from this commit: https://github.com/KhalilMrini/LAL-Parser/commit/e9e10ea7958e46e189444044f64fc84626647ca1
    ...
    def forward(self, xs, batch_idxs, extra_content_annotations=None):
        ...
        # added fix from this commit: https://github.com/KhalilMrini/LAL-Parser/commit/e9e10ea7958e46e189444044f64fc84626647ca1
        timing_signal = []
        ...
        # print("502:", content_annotations.size(), timing_signal.size())
